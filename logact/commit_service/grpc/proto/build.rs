...
fn main() -> std::io::Result<()> {
    ...
    let service_proto = manifest_dir.join("logact_commit_service.proto");
    ...
    let imported_protos = [
        (
            manifest_dir.join("../../../../bus/proto/agent_bus.proto"),
    ...
    tonic_prost_build::configure()
        .extern_path(".agent_bus", "::agent_bus_proto_rust::agent_bus")
        .compile_with_config(prost_config, &[service_proto], &[manifest_dir, out_dir])
}
